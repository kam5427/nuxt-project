      ...
      <div class="col-4 mb-2">
        <div class="row">
          ...
          <div class="v-cart-item-info col-lg-8 col-12">
            <nuxt-link class="cart-item-link" :to="`category/product/${cart_item_data.article}`"> <p>{{cart_item_data.pName}} <br> {{cart_item_data.pType}}<br>{{cart_item_data.pQty}}</p></nuxt-link>
          </div>
        </div>
      </div>
...
<!--        <p v-if="cart_item_data.quantity < cart_item_data.pQtyBox">{{cart_item_data.pRozPrice}}</p>-->
<!--        <p v-if="cart_item_data.quantity >= cart_item_data.pQtyBox">{{cart_item_data.pPrice}}</p>-->
