#000000<template>
  <div class="row mt-5 v-call">
    <div class="col-12 v-call-title">
      <h2 class="v-call-header" :class="[currentPage.includes('order') ? orderHeaderClass: '' ]">Не нашли что искали?</h2>
    </div>
    <div class="col-12">
      <div class="row">
        <div class="col-12 call-description" :class="[currentPage.includes('order') ? orderDescClass: '' ]">
  ...
  export default {
    ...
    data() {
      return {
        ...
        orderHeaderClass: 'v-call-header-black',
        orderDescClass: 'call-description-black'
      }
    },
    methods: {
      sendForm(e) {
