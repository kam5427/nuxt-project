          ...
          <div class="navbar-nav">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                ...
                <nuxt-link class="dropdown-item" to="/category/chekovaya-lenta">Лента для банкоматов</nuxt-link>
                <nuxt-link class="dropdown-item" to="/category/termoetiketki">Термоэтикетки(эко)стандарт</nuxt-link>
